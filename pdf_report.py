...
def register_fonts():
    ...
    # если DejaVuSans-Bold.ttf реально есть — ок. если нет, временно укажи твой bold-файл.
    pdfmetrics.registerFont(
...
"""
    ...
    structure_text = """В основе интерпретации лежит матрица потенциалов 3×3, где каждый ряд выполняет свою функцию.
...
"""
    ...
    cover_blocks += [
        ...
        Paragraph(intro_text.replace("\n", "<br/>"), body),

        Paragraph("Структура внимания и распределение энергии", header),
        Paragraph(structure_text.replace("\n", "<br/>"), body),
    ]
...
"""
    ...
    author_text = """Asselya Zhanybek — эксперт в области оценки и развития человеческого капитала, с профессиональным фокусом на проектах оценки компетенций и развития управленческих команд в национальных компаниях и европейском консалтинге, с применением психометрических инструментов.

...
def question_plan():
    return [
        ...
        {"id": "intake.ask_request", "stage": "intake", "type": "text",
         "text": "С каким запросом ты пришёл(пришла) на диагностику? (1–2 фразы)"},
        ...
        {"id": "intake.current_state", "stage": "intake", "type": "text",
         "text": "Что сейчас больше всего НЕ устраивает или забирает энергию?"},
        {"id": "intake.goal_3m", "stage": "intake", "type": "text",
         "text": "Прошло 3 месяца и стало лучше. Что изменилось в первую очередь?"},
        ...
        {"id": "now.praise_for", "stage": "now", "type": "text",
         "text": "За что тебя чаще всего хвалят? (1–3 пункта)"},
        ...
        {"id": "now.attention_first", "stage": "now", "type": "single",
         "text": "В новой ситуации что ты замечаешь первым?",
        ...
        {"id": "now.best_result_example", "stage": "now", "type": "text",
         "text": "Пример: ситуация → что сделал(а) → результат (то, что у тебя получается лучше большинства)."},
        ...
        {"id": "childhood.child_play", "stage": "childhood", "type": "multi",
         "text": "В детстве (6–12) что любил(а) больше всего? (1–3)",
        ...
        {"id": "childhood.teen_dream", "stage": "childhood", "type": "text",
         "text": "Подростком кем хотелось быть/чем заниматься?"},
        ...
        {"id": "behavior.free_time", "stage": "behavior", "type": "text",
         "text": "Если есть свободные 2 часа — что ты чаще всего делаешь?"},
        ...
        {"id": "antipattern.avoid", "stage": "antipattern", "type": "text",
         "text": "Какие задачи ты стабильно откладываешь (внутренне сопротивляешься)?"},
        {"id": "antipattern.hate_task", "stage": "antipattern", "type": "single",
         "text": "Что самое ‘нелюбимое’ из списка?",
        ...
        {"id": "antipattern.energy_leak", "stage": "antipattern", "type": "text",
         "text": "Где ты сильнее всего ‘сливаешь’ энергию сейчас?"},
    ]

...
def question_plan():
    ...
    return [
        # =========================
# 0) INTAKE (контекст — чистая диагностика природы)
# =========================

        {
          "id": "intake.answer_mode",
          "stage": "intake",
          "intent": "answer_mode",
          "type": "info",
          "text": (
            "Важно:\n"
            "Эта диагностика показывает твои базовые паттерны мышления, мотивации и действия.\n\n"
            "Отвечай не из текущего состояния (усталость, тревога, сложный период),\n"
            "а так, как ты обычно думаешь, выбираешь и действуешь в обычные периоды жизни.\n\n"
            "Если сомневаешься — ориентируйся на себя в возрасте 20–25 лет\n"
            "или на то, каким ты бываешь в хорошие, устойчивые дни."
...
def build_client_report_prompt():
    ...
    # IMPORTANT: use plain "-" (hyphen) and "3x3" (not "3×3") inside the text.

...
KEYWORDS = {
    "Аметист": [
        "уникал", "особенн", "своеобраз", "не как все",
        "анализ", "аналит", "мышлен", "логик", "причин", "следств", "закономер",
        "интуиц", "чутье", "предчув", "прогноз", "гипотез", "инсайт",
        "суть", "глуб", "системн мышл", "концепт", "картина мира",
        "стратег", "вектор", "направлен", "цель", "план", "управлен",
        "решени", "выбор", "рационал", "продум", "архитект",
        "знан", "ценител знан", "исслед", "разобрат", "пониман"
    ],

    "Гранат": [
        "мотивац", "эмоц", "чувств", "пережив", "состояни",
        "популяр", "признан", "вниман", "аудитор", "людям нрав",
        "имидж", "образ", "репутац", "впечатлен", "харизм", "привлекатель",
        "самопрезент", "показат", "видимост", "проявлен",
        "соцсет", "пост", "рилс", "контент", "подписчик", "лайк",
        "статус", "успех", "ценят", "оценят", "похвал", "одобр"
    ],

    "Цитрин": [
        "деньг", "доход", "прибыл", "выручк", "маржин", "монетиз",
        "результат", "эффект", "прогресс", "достиг", "сдела", "закры", "выполн",
        "быстр", "скорост", "эффектив", "kpi", "цифр", "метрик", "план факт",
        "продаж", "клиент", "сделк", "переговор", "договор", "коммерц",
        "выгод", "ресурс", "бюджет", "стоимост", "цена", "ценник",
        "запуск", "масштаб", "рост", "влияние на деньги", "рынок"
    ],
    
    "Сапфир": [
        "смысл", "зачем", "почему", "идея", "ценност", "предназнач",
        "духов", "осознан", "внутрен", "глубин", "философ",
        "концепц", "мировоззрен", "истин", "суть",
        "мисси", "направлен", "вектор жизни",
        "рефлекс", "размышл", "самопозн", "внутренний рост",
        "вдохновен", "инсайт", "мудрост"
    ],

    "Гелиодор": [
        "популяр", "продвиж", "промо", "маркетинг", "реклам",
        "пиар", "медиа", "сми", "публикац",
        "охват", "вирал", "трафик", "лид", "воронк",
        "упаковк", "позиционир", "бренд", "личный бренд",
        "контент", "рилс", "сторис", "пост", "инстаграм", "ютуб",
        "подписчик", "аудитор", "комьюнити",
        "узнаваем", "видимост", "публичн", "выступ"
    ],

    "Изумруд": [
        "гармони", "баланс", "спокойств", "мягк", "уют",
        "красот", "эстет", "стиль", "вкус", "атмосфер", "вайб",
        "дизайн", "упаковк", "визуал", "картинк", "цвет", "форма",
        "интерес к жизни", "радост", "удовольств", "наслажден",
        "эмоционал гармони", "тепло", "забот", "бережн",
        "комфорт", "качество", "красиво", "приятно"
    ],

    "Янтарь": [
        "порядок", "структур", "систем", "регламент", "правил", "инструкц",
        "процесс", "процедур", "чеклист", "таблиц", "учет", "контрол",
        "документ", "отчет", "дедлайн", "планирован", "расписан",
        "организац", "администр", "дисциплин", "рутин",
        "надежн", "стабильн", "аккурат", "точност",
        "здоров", "режим", "восстанов", "профилактик"
    ],

    "Рубин": [
        "адренал", "драйв", "эмоц", "вау", "впечатлен", "ярк",
        "сцена", "публика", "выступ", "ивент", "мероприят",
        "съемк", "камера", "видео", "ролик", "контент", "шоу",
        "праздник", "движ", "динамик", "экшн",
        "соревн", "азарт", "риск", "смел", "порыв"
    ],

    "Шунгит": [
        "спорт", "тело", "движ", "трен", "нагрузк", "мышц",
        "энерг", "вынослив", "сил", "форма",
        "здоров", "сон", "питани", "вода", "восстанов",
        "ходьб", "шаг", "кардио", "зал", "растяжк",
        "монотон", "физическ", "ручн труд", "работ руками"
    ],
}
